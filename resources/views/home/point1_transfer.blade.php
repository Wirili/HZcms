...
<div class="row">
    <div class="col-md-12">
        <h3>@lang('menu.trade_manager') <small>@lang('menu.point1_transfer')</small></h3>
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('menu.point1_transfer')</li>
        </ol>
    </div>
    <div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            @lang('menu.point1_transfer')
        </div>
        <div class="panel-body">
            <form class="form-horizontal" onsubmit="return false;">
                <div class="form-group">
                    <p class="col-md-4 col-md-offset-2 text-danger">您好! ({{Auth::user()->name}}). 您的可转出激活币为:{{Auth::user()->point1}}</p>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="">转出激活币</label>
                    <div class="col-md-4">
